<template>
  <div class="shoppingCart">
    ...
    <!-- 购物车主要内容区 -->
    <div v-if="getShoppingCart.length>0" class="content">
      <ul>
        <!-- 购物车表头 -->
        <li class="header">
          <div class="pro-check">
        ...
        <!-- 购物车列表 -->
        <li v-for="(item,index) in getShoppingCart" :key="item.id" class="product-list">
          <div class="pro-check">
          ...
          <div class="pro-action">
            <el-popover placement="right">
              ...
              <i slot="reference" class="el-icon-error" style="font-size: 18px;"></i>
            </el-popover>
          </div>
        </li>
        <!-- 购物车列表END -->
      ...
      <div class="cart-bar">
        ...
        <div class="cart-bar-right">
          ...
          <router-link :to="getCheckNum > 0 ? '/confirmOrder' : ''">
            <div :class="getCheckNum > 0 && getCheckNum < 2 ? 'btn-primary' : 'btn-primary-disabled'">去结算</div>
          </router-link>
        </div>
      </div>
      <!-- 购物车底部导航条END -->
